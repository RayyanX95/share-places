...
const Auth = () => {
  ...
  const authSubmitHandler = async (e) => {
    ...
    if (isLoginMode) {
      try {
        const parsedData = await sendRequest(`${process.env.REACT_APP_BACKEND_URL}/users/login`,
          "POST",
          JSON.stringify({
      ...
      try {
        ...
        const parsedData = await sendRequest(`${process.env.REACT_APP_BACKEND_URL}/users/signup`,
          'POST',
          formData,
        );
